    ...
    return (
        <>
            ...
            >
                ...
                <span className="font-medium text-sm px-[4px]">IPFS</span>
                {isOnline ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
